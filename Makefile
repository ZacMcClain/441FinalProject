########################################
## SETUP MAKEFILE
## modified form code by: Dr. Jeffrey Paone, Colorado School of Mines
## Set the appropriate TARGET (i.e. the
